...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.0-beta2/types/tx_msg.go#L72-L76

A standard implementation of both these objects can be found in the [`auth` module](../../x/auth/spec/README.md):

+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.0-beta2/x/auth/tx/decoder.go

+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.0-beta2/x/auth/tx/encoder.go
...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.0-beta2/x/auth/types/account.go#L301-L324
...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.0-beta2/codec/types/interface_registry.go#L25-L55
